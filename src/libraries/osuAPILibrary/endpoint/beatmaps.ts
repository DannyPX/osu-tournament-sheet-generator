 ...
 */
export const getUserBeatmapScore = (
  token: string,
  user: number,
  beatmap: number,
  legacy_only?: number,
 ...
 * @param {Ruleset=} mode `mode?` The **Ruleset** to get scores for.
 */
export const getUserBeatmapScores = (
  token: string,
  user: number,
  beatmap: number,
  legacy_only?: number,
 ...
 * @param {string=} type `type?` Beatmap score ranking type
 */
export const getBeatmapScoresNonLegacy = (
  token: string,
  beatmap: number,
  mode?: string,
  mods?: number | string[],
 ...
 * @returns 
 */
export const getBeatmapAttributes = (
  token: string,
  beatmap: number,
  mods?: number | string[],
  ruleset?: string,
